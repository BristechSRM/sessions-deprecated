...
type ProfilesController() = 
    ...
    member x.Get(id : Guid) = 
        ...
        | Failure error -> 
            Log.Information("Failure: Put request for profile with id: {id} failed with status code: {code} and message: {message}", id, error.HttpStatus, error.Message)
    ...
    member x.Post(newProfile : Profile) = 
        ...
        | Failure error -> 
            Log.Information("Failure: Post request for profile with id: {id} failed with status code: {code} and message: {message}", id, error.HttpStatus, error.Message)
            x.Request.CreateErrorResponse(error.HttpStatus, error.Message)
